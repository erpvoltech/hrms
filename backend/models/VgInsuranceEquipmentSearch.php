...
/**
 * VgInsuranceEquipmentSearch represents the model behind the search form of `app\models\VgInsuranceEquipment`.
 */
class VgInsuranceEquipmentSearch extends VgInsuranceEquipment
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['property_type', 'insurance_no', 'property_name', 'property_no', 'valid_from', 'valid_to', 'financial_year', 'location', 'user_division', 'insured_to', 'equipment_service', 'remarks'], 'safe'],
