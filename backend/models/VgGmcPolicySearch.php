...
/**
 * VgGmcPolicySearch represents the model behind the search form of `app\models\VgGmcPolicy`.
 */
class VgGmcPolicySearch extends VgGmcPolicy
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['policy_name', 'policy_no', 'from_date', 'to_date', 'remarks'], 'safe'],
            [['premium_paid'], 'number'],
        ];
    }
