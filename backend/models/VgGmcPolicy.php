...
/**
 * This is the model class for table "vg_gmc_policy".
 *
 * @property int $id
 ...
 */
class VgGmcPolicy extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['policy_name', 'insurance_comp_id', 'insurance_agents_id', 'policy_no', 'from_date', 'to_date', 'premium_paid'], 'required'],
            [['policy_name'], 'string'],
