 ...
 */
class EmpReportSearch extends EmpDetails
{
    public $unit_group;
    public function rules()
    {
        return [
            ...
            [['unit_group','employment_type', 'empcode', 'empname', 'doj', 'confirmation_date', 'division_id', 'email', 'mobileno', 'referedby', 'probation', 'appraisalmonth', 'recentdop', 'joining_status', 'experience', 'dateofleaving', 'reasonforleaving', 'photo', 'status'], 'safe'],
        ];
    }
