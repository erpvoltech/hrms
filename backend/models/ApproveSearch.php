 ...
 */
class ApproveSearch extends EmpSalary
{
    public $department;
    public $unit;
    public $designation;
    ...
    {
        return [          
            [['date','empname', 'empid', 'attendancetype','monthto', 'month','division_id','department_id','unit_id','designation','empcode','category','net_amount','netamountto'], 'safe'],
            ];
    }
  ...
  public function attributeLabels()
	...
	
    {
		...
		$query->andWhere(['hrapproval' =>1,'finance_approval1'=>NULL,'finance_approval2'=>NULL]);
