...
class VeplStationariesIssueSub extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['issue_id', 'stationaries_id', 'issued_qty'], 'required'],
            [['issue_id', 'stationaries_id', 'issued_qty'], 'integer'],
        ];
    }
    ...
    {
        return $this->hasOne(VeplStationaries::className(), ['id' => 'stationaries_id']);
    }
}
