    ...
    */
    ...
    public function rules()
    {
        return [			
            ...
            [['selection_mode','other_selection_mode', 'status', 'rejected_reason', 'process_status', 'join_status','ecode'], 'string'],
    ...
    {
        return $this->hasMany(RecruitmentBatch::className(), ['id' => 'batch_id']);
    }
