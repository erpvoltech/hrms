 ...
 <?php $form = ActiveForm::begin(); ?>
			...
			<div class="col-md-2">
			  <?= Html::submitButton('Save', ['class' => 'btn-sm btn-success']) ?>
			   ...
			   <?= Html::a('PDF-Header',['appointmentpdf?id='.$_GET['id']], ['target' => '_blank','class' => 'buttonOne btn-sm btn-danger']) ?>
			</div>
			</div> <div class="col-md-3">			   
			   <?= Html::a('PDF-Without-header',['appointment-without-header?id='.$_GET['id']], ['target' => '_blank','class' => 'buttonOne btn-sm btn-danger']) ?>
			</div>
