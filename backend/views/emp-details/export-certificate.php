...
$objPHPExcel->getActiveSheet()
		...
		->setCellValue('G1', 'Certificate Name')
		->setCellValue('H1', 'Certificate No')
		->setCellValue('I1', 'Issue Authority');
...
foreach ($model as $data) {
   ...
   $dataArray = array(
       ...
       $deptname['name'],      
	   $certdata->certificatesname,
	   $certdata->certificateno,
	   $certdata->issue_authority,	  
   );
...
header('Content-Disposition: attachment;filename="Emp_certificates.xlsx"');
