...
<div class="emp-salary-_form">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <br>
      <div class="row">
        <div class=" col-lg-4"> <?= $form->field($model, 'paiddays') ?></div>
        <div class=" col-lg-4">  <?= $form->field($model, 'over_time') ?></div>
        <div class=" col-lg-4">   <?= $form->field($model, 'arrear') ?></div>
      </div>
      <div class="row">
        <div class=" col-lg-4"> <?= $form->field($model, 'spl_allowance')?></div>
        <div class=" col-lg-4"> <?= $form->field($model, 'insurance') ?></div>
        <div class=" col-lg-4"> <?= $form->field($model, 'advance') ?></div>
      </div>
      <div class="row">
        <div class=" col-lg-4"> <?= $form->field($model, 'mobile') ?></div>
        <div class=" col-lg-4"> <?= $form->field($model, 'loan') ?></div>
        <div class=" col-lg-4"> <?= $form->field($model, 'rent') ?></div>
      </div>
      <div class="row">
        <div class="col-lg-4"> <?= $form->field($model, 'tds') ?></div>
        <div class=" col-lg-4"> <?= $form->field($model, 'lwf') ?></div>
        <div class=" col-lg-4"><?= $form->field($model, 'other_deduction') ?></div>
      </div>
