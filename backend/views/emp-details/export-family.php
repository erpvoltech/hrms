...
$objPHPExcel->getActiveSheet()
		...
		->setCellValue('M1', 'GMC No')
		->setCellValue('N1', 'SUM Insured')
		->setCellValue('O1', 'Age Group');
...
foreach ($model as $data) {
   ...
   $dataArray = array(
	   ...
	   $familydata->nominee,
	   $familydata->gmc_no,
	   $familydata->sum_insured,
	   $familydata->age_group,
   );
...
foreach ($model as $data) {
   ...
   $objValidation18 = $objPHPExcel->getActiveSheet()->getCell('O' . $i)->getDataValidation();
   ...
   $objValidation18->setFormula1('"0-35,36-45,46-50,51-55,56-60,61-65,66-70"'); 
