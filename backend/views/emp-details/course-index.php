...
error_reporting(0);
		...
		$query->FilterWhere(['emp_educationdetails.course' => $_GET['id']]);

        $dataProvider = new ActiveDataProvider([
            'query' => $query,
        ]);
		
		$coursequery = Course::find()->where(['id'=>$_GET['id']])->one();
?>
<div class="emp-details-index" >
   ...
   GridView::widget([
      ...
      'toolbar' => [
       ...
       'panel' => [
           'type' => 'info',
           'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-education"></i> '.$coursequery->coursename.'</h3>',
       ],
       'columns' => [
