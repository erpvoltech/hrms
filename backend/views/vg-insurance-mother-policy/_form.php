...
<div class="vg-insurance-agents-form">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <!--$form->field($vitalPolicy, 'policy_for_id')->dropDownList($policyName, ['prompt' => 'Select...'])-->
            ...
            <?php foreach ($modelHierarchy as $index => $hierarchyAmt): ?>
                <div class="item panel panel-default"><!-- widgetBody -->
                    <div class="panel-heading">
                        ...
                        <button type="button" id="buttonId" class="deleteRow pull-right remove-item btn btn-danger btn-xs"><i class="fa fa-minus"></i></button>
                        <div class="clearfix"></div>
                    </div>
