                ...
                <div class="col-lg-8" style="width:100%"> 
                    ...
                    <table class="table  table-condense" style="font-size:12px;" >
                        ...
                        foreach ($motherPolicy as $motherModel) {
                            ...
                            ?>
                            <tr style="text-align: left;"><td><?= $ispName->company_name ?></td><td><?= $ispAgent->agent_name ?></td><td><?= $motherModel->policy_no ?></td><td><?= date('d.m.Y', strtotime($motherModel->from_date)) ?></td><td><?= date('d.m.Y', strtotime($motherModel->to_date)) ?></td><td style="text-align: right;"><?= $motherModel->premium_paid ?></td><td><?= $motherModel->remarks ?></td>
                                <td>
                                    <?php
