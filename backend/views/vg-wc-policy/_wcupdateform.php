...
<div class="vg-wc-policy-form">
    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($vitalPolicy, 'policy_name')->dropDownList([ 'WC' => 'WC', ], ['prompt' => 'Select....']) ?>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
            ...
            echo $form->field($vitalPolicy, 'insurance_agents_id')->widget(DepDrop::classname(), [
                ...
                'data' => [$vitalPolicy->insurance_agents_id => $vitalPolicy->insurance_agents_id],
                'pluginOptions' => [
                    'depends' => ['vgwcpolicy-insurance_comp_id'],
                    'placeholder' => 'Select...',
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <?= $form->field($vitalPolicy, 'wc_type')->dropDownList([ 'Named' => 'Named', 'Unnamed' => 'Unnamed'], ['prompt' => 'Select....']) ?>
        </div>
    </div>
    
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($vitalPolicy, 'employer_name_address')->textarea(['rows' => 4, 'style' => 'resize: none; width: 100%;']) ?>
        </div>
    
        <div class="col-sm-6">
            <?= $form->field($vitalPolicy, 'contractor_name_address')->textarea(['rows' => 4, 'style' => 'resize: none; width: 100%;']) ?>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($vitalPolicy, 'nature_of_work')->textarea(['rows' => 4, 'style' => 'resize: none; width: 100%;']) ?>
        </div>
        <div class="col-sm-6">
            <?= $form->field($vitalPolicy, 'policy_holder_address')->textarea(['rows' => 4, 'style' => 'resize: none; width: 100%;']) ?>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($vitalPolicy, 'project_address')->textarea(['rows' => 4, 'style' => 'resize: none; width: 100%;']) ?>
        </div>
        <div class="col-sm-6">
            <?= $form->field($vitalPolicy, 'wc_coverage_days')->textInput(['maxlength' => true]) ?>
        </div>
    </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <i class="fa fa-envelope"></i> WC Hierarchy
            ...
            <?php foreach ($modelHierarchy as $index => $hierarchyAmt): ?>
                <div class="item panel panel-default"><!-- widgetBody -->
                    ...
                    <div class="order-list panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <?= $form->field($hierarchyAmt, "[{$index}]categories")->textInput() ?>
                            </div>
                            <div class="col-sm-4">
                                <?= $form->field($hierarchyAmt, "[{$index}]no_of_persons")->textInput() ?>
                            </div>

                            <div class="col-sm-4">
                                <?= $form->field($hierarchyAmt, "[{$index}]gross_salary_total")->textInput() ?>
                            </div>
...
$script = <<< JS
    ...
    $("#vgwcpolicy-insurance_comp_id").change(function(){
      $("#insurance_comp_id").depdrop({
        depends: ['vgwcpolicy-insurance_comp_id'],
        url: 'loadagents'
    });
    }).change();
