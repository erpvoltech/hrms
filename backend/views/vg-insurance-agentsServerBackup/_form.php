...
<div class="vg-insurance-agents-form">
    <div class="panel panel-default">
        <div class="panel-heading"><i class="fa fa-book">Insurance Agent Entry Form</i></div>
        <div class="panel-body">       
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <?= Html::button('', ['value' => Url::to('createcompany'), 'class' => 'glyphicon glyphicon-plus-sign btn btn-default btn-sm', 'id' => 'CompanyButton', 'title' => 'Add New Insurance Company']) ?>  
                </div> 
            </div>
