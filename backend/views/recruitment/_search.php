...
$batchData = ArrayHelper::map(RecruitmentBatch::find()->orderBy(['id' => SORT_DESC])->all(), 'id', 'batch_name');
?>
...
<div class="emp-details-search">
   ...
   <div class="row">
	  ...
	  <div class=" col-lg-4"> <?= $form->field($model, 'type')->dropDownList(['engineer' => 'Engineer', 'staff' => 'Staff'], ['prompt' => 'Select...']) ?></div>
   ...
   <!--<div class="row">      
      <div class=" col-lg-4"> <?= $form->field($model, 'position') ?></div>
   </div>
   
   <div class="row">
      <div class=" col-lg-4">
         <?= $form->field($model, 'year_of_passing') ?> </div>
      <div class=" col-lg-4">
         <?= $form->field($model, 'status') ?></div>
   </div>
   <div class="row">
