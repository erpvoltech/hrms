...
$batch = RecruitmentBatch::find()->all();
...
<div class="recruitment-form">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <br>
            <div class="row" id="recruitment_div">			
                <div class="col-lg-5">	                    
					<div class="row" id="batchdiv" style="<?php if($model->type == 'engineer'){ ?> display : block; <?php } else{ ?> display: none;  <?php } ?> ">
                        <div class="col-md-10">
					...
					<?php # if($model->selection_mode == 'rejected'){ ?>
					<div class="row">
                        <div class="col-md-10">
                ...
                <div class="col-lg-6">
					...
					<?php if($model->callletter_status == '1'){ ?>
					<div class="row">
                        <div class="col-md-10">
                            <?= $form->field($model, 'process_status')->dropDownList([ 'selected' => 'Selected', 'rejected' => 'Rejected', 'hold' => 'Hold', 'not attended' => 'Not attended', 'next batch' => 'Next Batch', 'others' => 'Others',], ['prompt' => '']) ?> </div>
                    </div>
					<?php } ?>
                    <br>  
                </div>		
            ...
            <br>
                <div class="row" id="recruitment_submit">
