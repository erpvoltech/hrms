...
<div class="vg-insurance-agents-form">
    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($vitalPolicy, 'policy_name')->dropDownList([ 'GMC' => 'GMC', ], ['prompt' => 'Select....']) ?>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            echo $form->field($vitalPolicy, 'insurance_agents_id')->widget(DepDrop::classname(), [
                ...
                'pluginOptions' => [
                    'depends' => ['vggmcpolicy-insurance_comp_id'],
                    'placeholder' => 'Select...',
                ...
                <div class="item panel panel-default"><!-- widgetBody -->
                    ...
                    <div class="order-list panel-body">
                        ...
                        <div class="row">
                            ...
                            <!--<div class="col-sm-4" id="liberty" style="display: none;">
                                <?
                            ...
                            <div class="col-sm-4" id="starhealth">
                                <?php
                                echo $form->field($hierarchyAmt, "[{$index}]age_group")->dropDownList(
...
$('#vggmcpolicy-insurance_comp_id').change(function() {
    if( $(this).val() == 1) {
        $('#liberty').show();
        $('#starhealth').hide();
    }
