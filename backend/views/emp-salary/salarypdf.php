...
if($statutory->gpa_applicability == 'Yes') {			
$employercontribution .= '<tr><td width="30%">GPA</td><td width="70%" align="right">'. round($statutory->gpa_premium/12).'</td></tr>';
}
if($statutory->gmc_applicability =='Yes') {				
$employercontribution .= '<tr><td width="30%">GMC</td><td width="70%" align="right">'. round($statutory->gmc_premium/24).'</td></tr>';
} 
...
Payslip for the month of: <b>'. Yii::$app->formatter->asDate($model->month, "php:F , Y").'</b></div>

<div style="padding:10px 0 5px 0">
<div style="float: left; width: 40%; margin-bottom: 0pt; border-right:1px solid #ccc;">
<div style="text-align:left;border-bottom: 1px solid #ccc;font-weight: 700;"><b>Employee Details</b></div>	
<table>
...
<tr><td colspan="2" style="text-align:left;border-bottom: 1px solid #ccc;font-weight: 700;"> <br><b>Employer Contribution</b></td>
'.$employercontribution.'
<tr><td colspan="2" > <br></td>
<tr><td width="30%"><b>CTC</b></td><td  width="70%" align="right"><b>'. ($model->earned_ctc + round($statutory->gpa_premium/12) + round($statutory->gmc_premium/24)) .'</b></td></tr>
</table>
</div>
	<div style="float: right; width: 55%; margin-bottom: 0pt;padding-left:5px; ">
<table>
<tr ><td width="60%" style="border-bottom: 1px solid #ccc;font-weight: 700;"><b>Components</b></td><td width="30%" align="right" style="border-bottom: 1px solid #ccc;font-weight: 700;"><b>Actual</b></td><td width="30%" align="right" style="border-bottom: 1px solid #ccc;font-weight: 700;"><b>Earnings</b></td></tr>
<tr><td>Base Pay</td><td align="right">'.$actual->basic.'</td><td align="right">'.$model->basic.'</td></tr>'.$earnings.'
<tr><td colspan="3" > <br></td>
<tr><td><b>Gross Earnings</b></td><td align="right"><b>'.$actual->gross.'</b></td><td align="right"><b>'.$model->total_earning.'</b></td></tr>	
<tr><td colspan="3" style="text-align:right;border-bottom: 1px solid #ccc;font-weight: 700;"> <br><b>Deductions</b></td>'.$deductions.'
<tr><td colspan="3" > <br></td>
<tr><td><b>Total Deduction<b></td><td align="right"></td><td align="right">'.$model->total_deduction.'</td></tr>	
<tr><td colspan="3" > <br></td>
<tr><td><b>NET PAY:</b></td><td align="right"></td><td align="right"><b>'.$model->net_amount.'</b></td></tr>
