...
$objPHPExcel->getActiveSheet()
        ...
        ->setCellValue('F1', 'Eligible I Half')
        ->setCellValue('G1', 'Eligible II Half')
        ->setCellValue('H1', 'Leave Taken I Half')
        ->setCellValue('I1', 'Leave Taken II Half')
        ->setCellValue('J1', 'Balance Leave I Half')
        ->setCellValue('K1', 'Balance Leave II Half');
...
foreach ($model as $data) {
   $payScale = EmpStaffPayScale::find()->where(['salarystructure' => $data->remuneration->salary_structure])->all();
   if (!$payScale) {
...
header('Content-Disposition: attachment;filename="Leave_Engg.xlsx"');
