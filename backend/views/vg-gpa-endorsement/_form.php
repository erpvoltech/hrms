...
$motherpolicyno = VgGpaPolicy::findone($_GET['id']);
$endorsmentPolicy->gpa_mother_policy_id = $motherpolicyno->policy_no;
...
<div class="vg-insurance-endorsement-form">
    ...
    <div class="row">
        <div class="col-sm-5">
            <?= $form->field($endorsmentPolicy, 'gpa_mother_policy_id')->textInput(['readonly' => true]) ?>
        </div>
        <div class="col-sm-5">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <i class="fa fa-envelope"></i> VG GPA Endorsement Hierarchy
