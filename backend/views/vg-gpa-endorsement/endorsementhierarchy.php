            ...
            <div class="row" style="width:100%">
                <div class="col-lg-8" style="width:100%"> 
                    <table class="table  table-condense" style="font-size:12px;" >
                        <tr class=" "><th colspan="12">  <div class="addrline"><span class="text">GPA Endorsement Hierarchy Details</span></div></th></tr>
                        <tr><th>Sum Insured</th><th>Fellow Share</th></tr>
                        <?php
                        $endorsmentHierarchy = VgGpaEndorsementHierarchy::find()->where(['gpa_endorsement_id' => $_GET['id']])->all();
