...
<div class="porec-training-index">	
	...
	<div class="row">
			...
			<div class="form-group col-lg-4 ">
				<?= $form->field($model, 'training_type')->dropDownList(['existing' => 'Existing']) ?>
			</div>
			<!--<div class="form-group col-lg-4 ">
	...
	<div class="row">
		<div id="employee_grid" class="col-lg-8" style="display: none;">	
		</div>	
		<div class="col-lg-3">
			<!--<div id="ecode_display">
			<span>Ecode</span><span>     </span><span>Name</span></br>-->
			<table class="" id="ecode_display" style="display: none";>
			<thead>
			<th>Ecode</th>
			<th>Name</th>
			</thead>
	...
	<div id="trainingbatch_grid" class="col-lg-9" style="display: none;">	
		<?php			
