...
<div class="row">
    <div class="col-md-5">
        <h4>Export Equipment Policy(EEP) Data</h4>
    </div>
</div>
<div class="row" style="border: 2px solid #000; line-height: 25px;">
    ...
    <div class="col-md-12" style="text-align:center"> Select Export Type :
        ...
        <br><br>
        <br>
        <button class="btn btn-default " type="button" id="exportequipment" style="text-align: center" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
            Equipment</button> <br><br><br>
    </div>
</div>
...
$script = <<<JS
     ...
     $("#exportequipment").click(function() {
         
     var exporttype = $('input[name=datavalue]:checked').val();
     if(exporttype){
            var printWindow = window.open('exportequipmentdata?type='+exporttype, 'Print', 'left=200, top=200, width=500, height=150, toolbar=0, resizable=0');
