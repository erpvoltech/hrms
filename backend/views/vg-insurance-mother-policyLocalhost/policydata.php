...
//print_r($agentNames);
    ?>
    <?php
        if ($model->policy_type == 'Asset Insurance') { ?>
            <div class="box-footer text-center">
                <?= Html::a('Create Asset Insurance', ['/vg-insurance-mother-policy/createasset'], ['class' => 'btn btn-success']) ?>
            </div>
    <?php } ?>
                ...
                <div class="col-lg-8" style="width:100%"> 
                    ...
                    <table class="table  table-condense" style="font-size:12px;" >
                        ...
                        foreach ($motherPolicy as $motherModel) {
                            ...
                            ?>
                            <?php if($motherModel->policy_for_id == 3) { ?>
                            <tr><th>ISP Name</th><th>Agent Name</th><th>Policy No</th><th style="width:8%"> Valid From </th><th style="width:8%"> Valid To </th><th style="width:10%">Premium Paid</th><th style="width:10%">Remarks</th></tr>
                            <?php } else { ?>
                            ...
                            <tr style="text-align: left;">
                                ...
                                <td><!-- $motherModel->policy_no -->
                                    <?php
                                    echo $motherModel->policy_no;
                                    ?>
                                </td>
                        <?php } else { ?>
                            <td><!-- $motherModel->policy_no -->
                                    <?php
                                    echo Html::a($motherModel->policy_no, \yii::$app->homeUrl . '/vg-insurance-mother-policy/policyhierarchy?id=' . $insuranceHierarchy->master_policy_id, ['target' => '_blank', 'style' => 'color:#0000FF; font-weight: bold']) . '<br>';
                                    ?>
                                </td>
                        <?php } ?>
