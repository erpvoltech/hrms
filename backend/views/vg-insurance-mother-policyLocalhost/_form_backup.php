...
<div class="vg-insurance-agents-form">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <?php
                echo $form->field($vitalPolicy, 'asset_type')->dropDownList(
    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($vitalPolicy, 'building_name')->textInput(['title' => 'Enter Insured Building Name', 'maxlength' => true]) ?>
        </div>
        <div class="col-sm-6">
            <?php
                echo $form->field($vitalPolicy, 'equipment_service')->dropDownList(
    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($vitalPolicy, 'asset_sum_insured')->textInput(['maxlength' => true]) ?>
        </div>
        <div class="col-sm-6">
...
$('#vginsurancemotherpolicy-policy_for_id').change(function() {
    if( $(this).val() == 3) {
        $('#vginsurancemotherpolicy-building_name').prop( "disabled", false );
        $('#vginsurancemotherpolicy-asset_type').prop( "disabled", false );
        $('#vginsurancemotherpolicy-asset_sum_insured').prop( "disabled", false );
        $('#vginsurancemotherpolicy-equipment_service').prop( "disabled", false );
    } else {       
        $('#vginsurancemotherpolicy-building_name').prop( "disabled", true );
        $('#vginsurancemotherpolicy-asset_type').prop( "disabled", true );
        $('#vginsurancemotherpolicy-asset_sum_insured').prop( "disabled", true );
        $('#vginsurancemotherpolicy-equipment_service').prop( "disabled", true );
        $('#vginsurancemotherpolicy-building_name').val('');
        $('#vginsurancemotherpolicy-asset_sum_insured').val('');
    }
});   
