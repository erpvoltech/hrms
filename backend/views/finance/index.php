 ...
 <?php Pjax::end(); ?>
	<div class="row">
		   <div class="col-md-5"> </div>
			   ...
			   <div class="col-md-2">  <button type="button" name ="bulkgenerate" id ="bulkgenerate" class="btn-xs btn-success pull-right">Salary Approval</button></div>
		   </div>
