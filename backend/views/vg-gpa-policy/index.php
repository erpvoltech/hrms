        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model) {
                        return Html::a('View/Export', ['vg-gpa-policy/gpaannexureindex', 'id' => $model->policy_no]);//.' / '.Html::a('Export', ['exportgpaannexdata', 'id' => $model->policy_no]);
                },
            ],
            
            /*[
                'header' => 'Endorsement Annexure',
                'format' => 'raw',
                'value' => function ($model) {
                        return Html::a('View', ['vg-gpa-endorsement/gpaendoannexure', 'id' => $model->endorsement_no]).' / '.Html::a('Export', ['exportgpaendoannexdata', 'id' => $model->endorsement_no]);
                },
            ],*/
