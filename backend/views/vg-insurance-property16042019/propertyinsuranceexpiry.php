...
$this->title = 'VG Property Insurance Expiry';
            ...
            <div class="row" style="width:100%">
                ...
                <div class="col-lg-8" style="width:100%"> 
                    ...
                    <table class="table  table-condense" style="font-size:12px;" >
                        <tr class=" "><th colspan="7">  <div class="addrline"><span class="text">Property Insurance Expired Details</span></div></th></tr>
                        <tr>
                            <th>Property Type</th>
                            <th>Insurance No</th>
                            <th>Property Name</th>
                        ...
                        foreach ($propertyExpiry as $data) {
                            ?>
                            <tr>
