...
<div class="row">
    <div class="col-md-5">
        <h4>Export Property Insurance System(EPIS) Data</h4>
    </div>
</div>
<div class="row" style="border: 2px solid #000; line-height: 25px;">
    ...
    <div class="col-md-12" style="text-align:center"> Select Export Type :
        ...
        <br><br>
        <br><br>
        <button class="btn btn-default " type="button" id="exportbuilding" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
            Building/Equipment/Vehicle</button> <br><br><br>
    </div>
</div>
...
$script = <<<JS
     ...
     if(exporttype){
            var printWindow = window.open('exportpidata?type='+exporttype, 'Print', 'left=200, top=200, width=500, height=150, toolbar=0, resizable=0');
