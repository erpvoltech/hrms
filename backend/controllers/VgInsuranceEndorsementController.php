...
class VgInsuranceEndorsementController extends Controller
{
    ...
    public function actionEndorsementhierarchy($id){
        $endorsementHierarchy = VgInsuranceEndorsementHierarchy::find()->where(['endorsement_policy_id' => $id])->all();
    ...
    public function actionCreate() {
        ...
        if ($endorsmentPolicy->load(Yii::$app->request->post())) {
            ...
            if ($valid) {
                ...
                try {
                    $motherpolicy = VgInsuranceMotherPolicy::find()->where(['policy_no'=>$endorsmentPolicy->mother_policy_id])->one();
                    $endorsmentPolicy->mother_policy_id = $motherpolicy->id;
