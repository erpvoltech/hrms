...
########################## End Fetch Data ##################	
            ...
            if ($Salarystructure && $remunerationmodel->attendance_type != 'Contract') {   //// For Site engg 				  			          		  
			   ...
			   $monthSalary = EmpSalarystructure::find()
                    ...
                    ->one();
				 if($model->unit_id == 12){
				   $Earned_Allovance = round(($ActualModel->dearness_allowance / $maxDays) * $present_days); 		                  
				   $tes =0;				  
				   } else {
				   ...
				   $earned_gross = ($model->basic + $model->hra +  $model->other_allowance +  $Earned_Allovance + $model->arrear + $model->holiday_pay + $model->spl_allowance + $model->over_time + $avance_tes);
              ...
              /* $workdays = 0;
               ...
               $model->spl_allowance = $model->spl_allowance;
               $model->guaranted_benefit = round(($ActualModel->guaranteed_benefit / $contract_workdays) * $present_days);
               ...
               $earned_gross = round($model->basic + $model->hra +  $model->dearness_allowance + $model->misc + $model->guaranted_benefit + $model->dust_allowance + $model->performance_pay +  $model->other_allowance + $model->arrear + $model->holiday_pay + $model->spl_allowance + $model->over_time);
