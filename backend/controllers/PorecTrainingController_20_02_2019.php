...
class PorecTrainingController extends Controller
{
		...
		'verbs' => [
			...
			'access' => [
				...
				'rules' => [			
					...
					[
						'allow' => true,
						'actions' => ['index','new','view','ajax-getregisterno','ajax-ecode','ajax-exist','ajax-selectedrecriutment','ajax-appendtraining','trainingbatchcreate','trainingbatchstore','trainingprocess','ajax-trainingselection','statusupdate','ajax-offerletterselection','ajax-bulkofferletterselection','sendofferletter','sendbulkofferletter','ajax-getofferlettercontent','offerletter'],
									  'allow' => true,
					...
					[
						'allow' => true,
						'actions' => ['index','new','update','ajax-getregisterno','ajax-ecode','ajax-exist','ajax-selectedrecriutment','ajax-appendtraining','trainingbatchcreate','trainingbatchstore','trainingprocess','ajax-trainingselection','statusupdate','ajax-offerletterselection','ajax-bulkofferletterselection','sendofferletter','sendbulkofferletter','ajax-getofferlettercontent','offerletter'],
									  'allow' => true,
									  'matchCallback' => function ($rule, $action) {
					...
					[
						'allow' => true,
						'actions' => ['index','new','create','ajax-getregisterno','ajax-ecode','ajax-exist','ajax-selectedrecriutment','ajax-appendtraining','trainingbatchcreate','trainingbatchstore','trainingprocess','ajax-trainingselection','statusupdate','ajax-offerletterselection','ajax-bulkofferletterselection','sendofferletter','sendbulkofferletter','ajax-getofferlettercontent','offerletter'],
									  'allow' => true,
									  'matchCallback' => function ($rule, $action) {
					...
					[
						'allow' => true,
						'actions' => ['index','new','delete','ajax-getregisterno','ajax-ecode','ajax-exist','ajax-selectedrecriutment','ajax-appendtraining','trainingbatchcreate','trainingbatchstore','trainingprocess','ajax-trainingselection','statusupdate','ajax-offerletterselection','ajax-bulkofferletterselection','sendofferletter','sendbulkofferletter','ajax-getofferlettercontent','offerletter'],
									  'allow' => true,
									  'matchCallback' => function ($rule, $action) {
	...
	public function actionAjaxSelectedrecriutment(){
		...
		$dataProvider = $recModel->search(['recModel'=>['batch_id'=>$data['batch'],'status'=>'selected']]);
		...
		echo "<script type='text/javascript'>
			$('document').ready(function(){
				$('#recruitmentbatch_grid .select-on-check-all').click(function() {												
					if($('#recruitmentbatch_grid  .select-on-check-all').prop('checked') == true){					 
						...
						$('#recruitmentbatch_grid input:checkbox:checked').map(function(){
						...
						var hiddenrecruitment_id_exist		=	$('#porectraining-recruitment_id').val();
						...
						$('#porectraining-recruitment_id').val(str_searchIDs);
				  ...
				  } if($('#recruitmentbatch_grid  .select-on-check-all').prop('checked') == false){
					$('.recruitmentcheckbox').prop('checked', false);
					//$('#recruitmentbatch_grid input[type=checkbox]').removeAttr('checked');
					$('#recruitmentbatch_grid  .select-on-check-all').val('check all');
					
					/*var unchecked_checkboxes	=	$('#recruitmentbatch_grid input:checkbox:not(:checked)').val();
					alert('unchecked_checkboxes: '+unchecked_checkboxes);
					var str_searchIDs_new_uncheck	=	$('#porectraining-recruitment_id').val();
					var hiddenrecruitment_id_exist	=	$('#porectraining-recruitment_id').val();
    ...
    {		
			...
			$ecode = EmpDetails::find()->where(['division_id' => $division,'unit_id' => $unit,'department_id' => $department])->all();
			
			foreach($ecode as $resecode){
				echo "<option value='".$resecode['empcode']."'>".$resecode['empcode']."-".$resecode['empname']."</option>";
			}					
    }
	...
	public function actionAjaxGetofferlettercontent(){
		...
		$pomodel->offerletter	= "<p>&nbsp;</p>
						...
						<p><strong>&nbsp;</strong></p>
						<p>Ref: VEPL/Offer/".$offer_date_reverse."/009&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
