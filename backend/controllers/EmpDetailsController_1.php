				...
				'access' => [
					...
					'rules' => [
						...
						[
							...
							'remuneration','promotion-exportcontract','print-empdetails','appointmentpdf','college-index','course-index','qualification-index',
							],
										  'allow' => true,
   ...
   public function actionIndex() {
    ...
    public function actionResignedIndex() {
	 ...
	 $currentdate = date('Y-m-d');
	  $model = EmpDetails::find()->where(['between', 'last_working_date', $salmonth->month , $currentdate]);
								//->andWhere(['status'=>'Relieved']);
	 ...
	 $salmonth = SalaryMonth::find()->orderBy(['month' => SORT_DESC])->one();
	 $currentdate = date('Y-m-d');
     $model = EmpDetails::find()->where(['between', 'doj', $salmonth->month , $currentdate]);
