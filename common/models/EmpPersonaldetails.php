 ...
 */
class EmpPersonaldetails extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            [['empid'], 'required'],
            [['empid'], 'integer'],
            [['dob', 'birthday', 'passportvalid','year_of_marriage'], 'safe'],
            ...
            [['passportno'], 'string', 'max' => 8],
            [['drivinglicenceno'], 'string', 'max' => 50],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
			...
			'year_of_marriage' =>'Date of Marriage',
            'panno' => 'Panno',
            'aadhaarno' => 'Aadhaarno',
