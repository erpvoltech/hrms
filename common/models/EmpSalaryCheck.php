...
class EmpSalaryCheck extends \yii\db\ActiveRecord {
   ...
   public function rules() {
      return [
          ...
          [['date', 'month'], 'safe'],
          [['user', 'empid', 'designation', 'unit_id', 'department_id','revised','email_status','customer_id','hold'], 'integer'],
