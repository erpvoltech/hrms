...
class Finance extends \yii\db\ActiveRecord {
   ...
   public function rules() {
      return [
          ...
          [['date', 'month'], 'safe'],
          [['user', 'empid', 'designation', 'unit_id', 'department_id','revised','email_status','customer_id','hold','finance_approval1','finance_approval2'], 'integer'],
   ...
   public function getSalary() {
      return $this->hasOne(EmailSeparate::className(), ['emp_id' => 'empid']);
   }
   
    public function getFinance() {
      return $this->hasOne(Finance::className(), ['empid' => 'empid']);
   }
