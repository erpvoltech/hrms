...
class ProjectDetailsSearch extends ProjectDetails
{
    ...
    public function rules()
    {
        return [
            ...
            [['project_code', 'location_code', 'job_details', 'state','district' ,'compliance_required', 'consultant', 'project_status', 'remark','location'], 'safe'],
        ];
    }
    ...
    {
        $query = ProjectDetails::find()->orderBy([
  'id' => SORT_DESC]);
        ...
        $query->andFilterWhere(['like', 'project_code', $this->project_code])
            ->andFilterWhere(['like', 'principal_employer', $this->principal_employer])
