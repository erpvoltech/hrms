...
<html lang="en">
	...
	<div class="pay_wraper">
		<div class="pay_container">
                          ...
                          <thead>                            
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php #echo $topicModel[0]->topic_name; ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td>Date</td>
                                  <td> <?php echo date("d/m/y",strtotime($trainingModel[0]->training_enddate)) ?></td>
                                </tr>
                          </thead>						
						</table>
                  <div>
                ...
                <tr>
                      <td colspan="6" >
                        <pre style="font-family: 'Roboto', sans-serif;font-size: 14px;">                          E- Excellent, 	       G- Good, 	             A- Average, 	       P-Poor</pre>
                        <br>
