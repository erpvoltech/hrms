...
<div class="panel panel-info">
   <div class="panel-heading text-center" style="font-size:18px;">Existing Emlpoyees Attendance Report</div>
   <div class="panel-body">
   <h1><?= Html::encode($this->title) ?></h1>
    <div class="porec-training-index">
		<?php $form = ActiveForm::begin(			
				['action' => ['postrectraining/exsitingattendanceReport_print'],'method' => 'post','layout' => 'horizontal',
				]); ?>
		<br>	
		<div class="row">
...
$script = <<< JS
	$("#porectraining-training_batch_id").change(function(){		
		...
		$.post("index.php?r=postrectraining/ajax-existingtrainingselectionreport",{'training_batch_id':training_batch},function(response){	
		//$.post("ajax-existingtrainingselectionreport",{'training_batch_id':training_batch},function(response){	
			//alert(response);
