...
<html lang="en">
	...
	#echo "<pre>";print_r($topicModel);echo "</pre>";	
	?>
			...
			<div class="pay_container">				
				<div class="emp_info row_section clearfix">                      
						<table class="" border="0" align="center" style="font-weight: bold;">
                          <thead>                            
								<tr>
									<td>Training Attendance Sheet <br>
                                ...
                                <tr>
                                    <td></td>
                                    <td align="right">Date: <?php echo date("d-m-Y",strtotime($print_date)); ?></td>
                                </tr>
								<tr>
					...
					<table class="table table_line" align="center" style="border: 1px solid #000;">                                            
						...
						if($trainingModel[0]->training_type == 'existing'){
							...
							foreach($rec_id as $res){
								...
								->one();
								$departmentModel = Department::find()
								->where(['id' => $empModel->department_id])
								->one();
								$unitModel = Unit::find()
								->where(['id' => $empModel->unit_id])
								->one();
							?>						
								<tr>
									<td><?php echo $i; ?></td>
									<td><?php echo $empModel->empcode; ?></td>
									<td><?php echo $empModel->empname; ?></td>
									<td><?php echo $unitModel['name'] . ' ('. $departmentModel['name'].')'; ?></td>
									<td></td>								
								</tr>
							<?php 
							$i++;
				...
				<div class="emp_info row_section clearfix">                      
						<table class="table table_line" align="center" style="font-weight: bold;">                                                 
							...
							<tr>								
								<td colspan="3" style="text-align: center; width: 250px;"><strong>
								</strong><br><br><br></td>
								<td style="text-align: center;"><strong></strong></td>									
							</tr>
                            <tr>
								<td colspan="3" style="text-align: center; width: 250px;"><strong>V.Raja Santosh Kumar</strong></td>
								<td style="text-align: center;"><strong>E.Kumaresan</strong></td>
                            </tr>		                         					
						</table>
				</div>
			</div>
