   ...
   <h1><?= Html::encode($this->title) ?></h1>
    <div class="porec-training-index">
		<?php $form = ActiveForm::begin(			
				['action' => ['postrectraining/existingattendanceadd'],'method' => 'post','layout' => 'horizontal',
				]); ?>
		<br>	
		<div class="row">
...
$script = <<< JS
	$("#porectraining-training_batch_id").change(function(){		
		...
		$.post("index.php?r=postrectraining/ajax-existingtrainingselection",{'training_batch_id':training_batch},function(response){	
		//$.post("ajax-existingtrainingselection",{'training_batch_id':training_batch},function(response){	
			//alert(response);
