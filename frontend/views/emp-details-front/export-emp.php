...
$objPHPExcel->getActiveSheet()
        ...
        ->setCellValue('AP1', 'PT')
        ->setCellValue('AQ1', 'PAN No')
        ->setCellValue('AR1', 'Aadhaar No')
        ->setCellValue('AS1', 'Passport No')
        ->setCellValue('AT1', 'Passport Valid')
        ->setCellValue('AU1', 'Passport Remarks')
        ->setCellValue('AV1', 'Voter ID')
        ->setCellValue('AW1', 'Driving Licence No')
        ->setCellValue('AX1', 'Licence Categories')
        ->setCellValue('AY1', 'Licence Remarks')
        ->setCellValue('AZ1', 'Referred By')
        ->setCellValue('BA1', 'Probation')
        ->setCellValue('BB1', 'Appraisal Month')
        ->setCellValue('BC1', 'Latest Promotion Date')
        ->setCellValue('BD1', 'Joining Status')
        ->setCellValue('BE1', 'Previous Experience')
        ->setCellValue('BF1', 'Date of Leaving')
        ->setCellValue('BG1', 'Reason for Leaving')		
        ->setCellValue('BH1', 'Status');
...
$objPHPExcel->getActiveSheet()->setSharedStyle($sharedStyle1, "A1:BH1");
$objPHPExcel->getActiveSheet()->getStyle('A1:BH1')->getAlignment()->setWrapText(TRUE);
$objPHPExcel->getActiveSheet()->getStyle('A1:BH1')->getFont()->setBold(true);
$objPHPExcel->getActiveSheet()->setAutoFilter('A1:BH1');
...
foreach ($model as $data) {
   $objPHPExcel->getActiveSheet()->setSharedStyle($sharedStyle2, 'A' . $j++ . ':BH' . $k++);
}
$j--;
$k--;
