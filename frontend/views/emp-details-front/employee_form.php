   ...
   <div class="panel panel-default">
      ...
      <div class="panel-body">
         <div class="row">
			...
			<?= $form->field($model, 'empcode')->textInput(['disabled' => 'disabled']) ?>				
			</div>
            <div class="form-group col-lg-4 ">
			<?= $form->field($model, 'empname')->textInput(['disabled' => 'disabled']) ?>				
			</div>      
			
			<div class="form-group col-lg-4 ">
				<?= $form->field($model, 'category')->textInput(['disabled' => 'disabled']) ?>				
			</div>
         </div>
        ...
        <div class="row"> 
			<div class="form-group col-lg-4 ">			
				<div class="form-group field-empdetailsfront-empcode col-sg-4">
					<label class="control-label col-sm-3" for="empdetailsfront-unit_id">Designation</label>
					<div class="form-group col-sm-4 ">
						<?php if($model->designation != '') { ?>
						<label class="control-label col-sm-3" for="empdetailsfront-designation"><?php echo $designation->designation; ?></label>
						<?php  } ?>
					</div>					
				</div>				
            </div>
			<div class="form-group col-lg-4 ">
				<div class="form-group field-empdetailsfront-empcode col-sg-4">
				<label class="control-label col-sm-3" for="empdetailsfront-unit_id">Unit</label>
				<div class="form-group col-sm-4 ">
					<?php if($model->unit_id != '') { ?>
					<label class="control-label col-sm-3" for="empdetailsfront-unit_id"><?php echo $unitData->name; ?></label>
					<?php  } ?>
				</div>					
				</div>
			</div>
         ...
         <div class="row">			
            <div class="form-group col-lg-4 ">			
				<div class="form-group field-empdetailsfront-empcode col-sg-4">
				<label class="control-label col-sm-3" for="empdetailsfront-unit_id">Division</label>
				<div class="form-group col-sm-4 ">
					<?php if($model->division_id != '') { ?>
					<label class="control-label col-sm-3" for="empdetailsfront-division_id"><?php echo $divData->division_name; ?></label>
					<?php  } ?>
				</div>					
				</div>
            </div>
            <div class="form-group col-lg-4 ">				
				<div class="form-group field-empdetailsfront-empcode col-sg-4">
				<label class="control-label col-sm-3" for="empdetailsfront-unit_id">Department</label>
				<div class="form-group col-sm-4 ">
					<?php if($model->department_id != '') { ?>
					<label class="control-label col-sm-3" for="empdetailsfront-department_id"><?php echo $deptData->name; ?></label>
					<?php  } ?>
				</div>					
				</div>			
