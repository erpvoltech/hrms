...
<div class="emp-details-search">
   ...
   <div class="row">      
      <div class=" col-lg-4">
         <?= $form->field($model, 'category')->dropDownList([ 'HO Staff'=>'HO Staff','BO Staff'=>'BO Staff','International Engineer'=>'International Engineer','Domestic Engineer'=>'Domestic Engineer'], ['prompt' => 'Select...']) ?></div>
