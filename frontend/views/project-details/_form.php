...
<div class="project-details-form">
	...
	<div class="row">
		<div class="col-lg-6">
			<?= $form->field($model,'project_name')->textInput(['maxlength'=> 40]) ?>
		</div>
		<div class="col-lg-6">
	...
	<div class="row">
		...
		<div class="col-lg-6">
			<?= $form->field($model, 'po_deliverydate')->widget(yii\jui\DatePicker::className(), [
            'dateFormat' => 'dd-MM-yyyy',			
        ]) ?> 
		</div>
	</div>
	...
	<div class="row">
	<div class="col-sm-12">
	<table style="width:70%;position: relative;left: 202px;">
	<tr>
	<th>HR Contact</th><th>Technical Contact</th>
	</tr>
	<tr>
	<td><?= $form->field($model,'pehr_name')->textInput(['maxlength'=> true,'id'=>'text1']) ?></td>
	<td><?= $form->field($model,'petech_name')->textInput(['maxlength'=> true,'id'=>'text2']) ?></td>
	</tr>
	<tr>
	<td><?= $form->field($model,'pehr_contact')->textInput(['maxlength'=> true,'id'=>'text3']) ?></td>
	<td><?= $form->field($model,'petech_contact')->textInput(['maxlength'=> true,'id'=>'text4']) ?></td>
	</tr>
	<tr>
	<td><?= $form->field($model,'pehr_email')->textInput(['maxlength'=> true,'id'=>'text5']) ?></td>
	<td><?= $form->field($model,'petech_email')->textInput(['maxlength'=> true,'id'=>'text6']) ?></td>
	</tr>
	</table>
	</div>
	</div>
	...
	<div class="row">
        ...
        <div class="col-sm-6">
		<?= Html::Button('same as', ['class' => 'btn btn-success','id'=>'copy']) ?>
        </div>
    </div>
	<div class="row">
	<div class="col-sm-12">
	...
	<td><?= $form->field($model,'conhr_name')->textInput(['maxlength'=> true,'id'=>'text11']) ?></td>
	<td><?= $form->field($model,'contech_name')->textInput(['maxlength'=> true,'id'=>'text12']) ?></td>
	<tr>
	<td><?= $form->field($model,'conhr_contact')->textInput(['maxlength'=> true,'id'=>'text13']) ?></td>
	<td><?= $form->field($model,'contech_contact')->textInput(['maxlength'=> true,'id'=>'text14']) ?></td>
	</tr>
	<tr>
	<td><?= $form->field($model,'conhr_email')->textInput(['maxlength'=> true,'id'=>'text15']) ?></td>
	<td><?= $form->field($model,'contech_email')->textInput(['maxlength'=> true,'id'=>'text16']) ?></td>
	</tr>
	</table>
	</div>
	</div>
	...
	<tr>
	<td><?= $form->field($model,'consulthr_name')->textInput(['maxlength'=> true]) ?></td>
	<td><?= $form->field($model,'consultech_name')->textInput(['maxlength'=> true]) ?></td>
	</tr>
	<tr>
	<td><?= $form->field($model,'consulthr_contact')->textInput(['maxlength'=> true]) ?></td>
	<td><?= $form->field($model,'consultech_contact')->textInput(['maxlength'=> true]) ?></td>
	</tr>
	<tr>
	<td><?= $form->field($model,'consulthr_email')->textInput(['maxlength'=> true]) ?></td>
	<td><?= $form->field($model,'consultech_email')->textInput(['maxlength'=> true]) ?></td>
	</tr>
	</table>
	</div>
	</div>
	...
	<div class="row">
	<div class="col-lg-6">
		<!--<?= $form->field($model, 'compliance_required')->dropDownList([ 'EPF' => 'EPF', 'ESI' => 'ESI', 'WC' => 'WC', 'CLRA(S)'=>'CLRA(S)','CLRA(C)'=>'CLRA(C)','ISMW'=>'ISMW','Factories Act'=>'Factories Act','GPA'=>'GPA','SALARY'=>'SALARY'],  ['prompt' => '']) ?>-->
		<?=$form->field($model, 'compliance_required[]')->widget(MultiSelect::classname(), [
    'data' => ['EPF' => 'EPF', 'ESI' => 'ESI', 'WC' => 'WC', 'CLRA(S)'=>'CLRA(S)','CLRA(C)'=>'CLRA(C)','ISMW'=>'ISMW','Factories Act'=>'Factories Act','GPA'=>'GPA','SALARY'=>'SALARY'],
