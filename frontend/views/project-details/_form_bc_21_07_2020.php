...
<div class="project-details-form">
	...
	<tr>
	<td><?= $form->field($model,'pehr_contact')->textInput(['maxlength'=> true]) ?></td>
	<td><?= $form->field($model,'petech_contact')->textInput(['maxlength'=> true]) ?></td>
	</tr>
	<tr>
	<td><?= $form->field($model,'pehr_email')->textInput(['maxlength'=> true]) ?></td>
	<td><?= $form->field($model,'petech_email')->textInput(['maxlength'=> true]) ?></td>
	</tr>
	</table>
	</div>
	</div>
	...
	<tr>
	<td><?= $form->field($model,'conhr_contact')->textInput(['maxlength'=> true]) ?></td>
	<td><?= $form->field($model,'contech_contact')->textInput(['maxlength'=> true]) ?></td>
	</tr>
	<tr>
	<td><?= $form->field($model,'conhr_email')->textInput(['maxlength'=> true]) ?></td>
	<td><?= $form->field($model,'contech_email')->textInput(['maxlength'=> true]) ?></td>
	</tr>
	</table>
	</div>
	</div>
    ...
    'data' => ['EPF' => 'EPF', 'ESI' => 'ESI', 'WC' => 'WC', 'CLRA(S)'=>'CLRA(S)','CLRA(C)'=>'CLRA(C)','ISMW'=>'ISMW','Factories Act'=>'Factories Act','GPA'=>'GPA'],
