...
foreach ($model as $att) {
	$unit = unit::findOne($att->unit);
		...
		foreach ($Unitgroup as $group) {
			...
			$modelEmpcount  += EmpDetails::find()->where(['division_id' => $group->division_id, 'unit_id' => $unit->id, 'status' => 'Active'])
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-4">
				...
				?>
				<h4><a href="index.php?r=project-details/mis-view&ec=">viewlist</a></h4>
			...
			<div class="col-sm-4">
				...
				echo "<h2>$project</h2>";
				?>
				<h4><a href="index.php?r=project-details/project-list">viewlist</a></h4>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-4">
				...
				if (Yii::$app->user->identity->role == 'unit admin') {
					...
					//echo '<h4><a href="index.php?r=project-details/engineerlist-projectadmin">Engineer Transfer</a></h4>';
					echo '<h4><a href="index.php?r=project-details/mis-view&ec=">MIS</a></h4>';
					echo '<h4><a href="index.php?r=project-details/unitadmin-emplist">Division Transfer</a></h4>';
					
					echo '<h4><a href="index.php?r=project-details/unitadmin-castatt">Cast Attendance</a></h4>';
				}
				if (Yii::$app->user->identity->role == 'unit admin') {
				...
				echo '<h4><a href="index.php?r=project-details/dashboard-ir">Track Sheet</a></h4>';
				}
				?>
			</div>
			<div class="col-sm-4">
