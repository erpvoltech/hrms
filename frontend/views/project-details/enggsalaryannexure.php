...
if ($statutory->professionaltax == 'Yes') {
 if ($model->gross_salary > 12500) {
  ...
  $subtotalc = $provident_fund_er + $model->employer_esi_contribution + $pliAmt +$model->employer_lta_contribution + $model->employer_medical_contribution + $gpa + $gmc + $variable_allowance;
...
<br><br><br><br><br>
<table border="1" style="border-collapse: collapse; padding-top:20px ">
...
<tr><td align="center"><b>COST TO THE COMPANY(A+C) </b></td><td style="text-align: right; font-weight: bold;"> <?= number_format($totalactual + $subtotalc,2, '.','')?></td><td style="text-align: right; font-weight: bold;"> <?= number_format(($totalactual + $subtotalc) * 12,2,'.', '') ?></td></tr>

<tr><td colspan="4" align="center"><b>Other Benefits / Eligibility </b></td></tr>  

<tr><td> Travel mode Eligibility </td><td colspan="2"><?=$benefits->travelmode_ts?></td> <td align="center" rowspan="4">The Eligibility values depends on work level, which is subjected to change by Management Discretion. Insurance Premium value shall differ based upon the offer by Insurer.</td></tr>
