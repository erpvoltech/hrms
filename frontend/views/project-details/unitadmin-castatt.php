...
<h2>Attendance</h2>
<br>
<table class="table table-striped"><tr><th style="width:10px;text-align:center;">Sl.No</th><th style="text-align:center;width:20px">Division</th><th style="width:20px;text-align:center">Date</th><th style="width:20px;text-align:center">Cast Attendance</th><th style="width:20px;text-align:center">View</th></tr>
<?php 
